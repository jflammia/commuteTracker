...
* **dashboard:** scan all rows for schema inference in API client ([a734ebc](https://github.com/jflammia/commuteTracker/commit/a734ebce034bad128ec601095aae2e2d0ba8e3ef))
